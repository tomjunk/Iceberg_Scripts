...
lar -n 1 -c /home/nfs/dunecet/artdaq/iceberg/analysis_scripts/idtmon2000.fcl -T ${fname}_monitor.root $1

root -b -l <<EOF
.x /home/nfs/dunecet/artdaq/iceberg/analysis_scripts/makeplots_test.C("${fname}_monitor.root");
.q
EOF
