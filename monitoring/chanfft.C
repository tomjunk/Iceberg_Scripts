...
void chanfft(std::string const& filename="iceberg_r003193_sr01_20200214T185432_1_dl1_decode.root",  
             size_t ievcount=0, 
             size_t tickmin=0,
             size_t tickmax=2000, 
	...
	if (!rawdigits.empty())
	  {
	    ...
	    TProfile *cf1dt = (TProfile*) new TProfile("cf1d","FFT Avg all chans",nticks/2,0,digifreq/2.0);
